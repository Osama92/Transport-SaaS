        ...
        <div className="mb-6 p-4 bg-yellow-50 border-2 border-yellow-400 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-yellow-900 mb-1">Test Mode Active</h3>
              <p className="text-xs text-yellow-800 mb-2">
                Use test OTP code: <span className="font-mono font-bold text-yellow-900 bg-yellow-200 px-2 py-0.5 rounded">123456</span>
              </p>
              <p className="text-xs text-yellow-700">
                Real SMS sending disabled to avoid CORS issues during development.
              </p>
            </div>
          </div>
        </div>
